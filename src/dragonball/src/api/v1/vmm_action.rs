...
impl VmmService {
    ...
    fn configure_boot_source(
        ...
        let kernel_file = File::open(&boot_source_config.kernel_image_path)
    ...
    fn manipulate_fs_backend_fs(
        ...
        if !vm.is_vm_initialized() {
            return Err(VmmActionError::FsDevice(FsDeviceError::MicroVMMustRunning));
        }
